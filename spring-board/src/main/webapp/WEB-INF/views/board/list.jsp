            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <button id="regBtn" type="button" class="btn btn-xs pull-right btn-primary">Register New Board</button>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class='row'>
                            	...
                            	<form id='searchForm' action="/board/list" method='get'>
                            		<select name='type'>
                            			...
                            			<option value="TWC"
                            				<c:out value="${pageMaker.cri.type eq 'TWC' ? 'selected' : ''}" />>제목 or 작성자 or 내용
                            			</option>
                            		</select>
